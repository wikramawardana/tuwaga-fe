        ...
        <div className="relative h-40 bg-primary-container">
          ...
          <div className="absolute bottom-4 left-5">
            <span className="rounded-full bg-secondary px-3 py-1 text-[11px] font-bold uppercase tracking-wider text-on-secondary">
              {summary?.tournament.badge ?? "Tournament"}
            </span>
...
export default function TournamentRegisterPage() {
      ...
      try {
        ...
        setMessage(
          err instanceof Error
            ? err.message
            : "Failed to load tournament registration.",
        );
      } finally {
  ...
  return (
    <RegistrationShell
      ...
      description={`${tournament.venue} — ${tournament.dateLabel}. Fill in your pair details below.`}
      showProgress={false}
    >
      <div className="grid grid-cols-1 gap-[24px] lg:h-[calc(100dvh-13.5rem)] lg:min-h-[620px] lg:grid-cols-12 lg:items-start lg:overflow-hidden">
        ...
        >
          ...
          <FormSection
            ...
            description="Your doubles partner for this tournament."
          >
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              <div className="space-y-2">
